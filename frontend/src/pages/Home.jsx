    ...
    <>
      ...
      <section className="relative w-full h-[85vh] bg-white flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4">
          ...
          <Link to="/products" className="bg-black text-white px-10 py-4 font-semibold uppercase tracking-wide hover:bg-gray-900 transition-colors">
            Shop Collection
          </Link>
        </div>
      </section>
      ...
      <section className="w-full py-16 bg-white">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((item) => (
              <Link key={item} to={`/products/${item}`} className="group">
      ...
      <section className="w-full py-16 bg-black text-white">
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 text-center">
          ...
          <Link to="/sablon" className="inline-block bg-white text-black px-10 py-4 font-semibold uppercase tracking-wide hover:bg-gray-100 transition-colors">
            Start Your Design
          </Link>
        </div>
      </section>
